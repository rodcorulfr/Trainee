...
public class Carregando extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Carregando frame = new Carregando();
	...
	public Carregando() {
		...
		Fantasminha.setIcon(new ImageIcon(Carregando.class.getResource("/GIf/Fantasminha.gif")));
		...
		GIF_Loading.setIcon(new ImageIcon(Carregando.class.getResource("/GIf/Loading-220.gif")));
